...
try:
    ...
    logging.warning("Azure AI Inference SDK not available. AI agent features will be disabled.")
...
class AIAgentService:
    """
    Service for handling Azure AI Foundry agent interactions.
    ...
    def __init__(self, config: DefaultConfig):
        ...
        if AI_INFERENCE_AVAILABLE and self._has_required_config():
            self._initialize_ai_client()
    
    def _has_required_config(self) -> bool:
        """Check if required AI configuration is available."""
        return bool(self.config.AI_ENDPOINT and 
                   (self.config.AI_API_KEY or self.config.AI_PROJECT_CONNECTION_STRING))
    ...
    def is_available(self) -> bool:
        ...
        return AI_INFERENCE_AVAILABLE and self.is_configured
